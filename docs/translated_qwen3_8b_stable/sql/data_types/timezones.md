...
可以从 `pg_timezone_names()` 表函数中获取此列表的最新版本：
...
| America/Indiana/Vincennes        | America/Indiana/Vinc
...
| Antarctica/Vostok                | Antarctica/Vost
...
| Pacific/Kiritimati               | Pacific/Kiritimmi                |
